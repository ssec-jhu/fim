    ...
    for i in range(rows):
        for j in range(cols):
           for k in range(deps):
                ...
                sigma=[[sigma_vec[0],sigma_vec[3],sigma_vec[4]],[sigma_vec[3],sigma_vec[1],sigma_vec[5]],[sigma_vec[4],sigma_vec[5],sigma_vec[2]]]
...
def main():   
    ...
    res_1 = least_squares(residual,initial_guess,bounds=bnds,args=(tensor_displacement_list,v12,v23,Gt,X,Y,Z,Force,cube_size))
    print(res_1.x)  
